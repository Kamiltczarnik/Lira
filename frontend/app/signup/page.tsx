...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Build the payload (this payload is not sent anywhere, it's just for simulation)
      const payload = {
        username,
        password,
      ...
      // Simulate saving data to localStorage (if needed)
      const dummyData = {
      ...
      localStorage.setItem("customerId", dummyData.customer_id)
      localStorage.setItem("username", username)
      localStorage.setItem("userData", JSON.stringify(dummyData))

      toast.success("Signup successful!")
      // Redirect to the login page (or login section)
      router.push("/#login")
    } catch (error) {

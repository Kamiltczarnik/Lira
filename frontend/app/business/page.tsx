...
const PageLayout = ({ title, description, buttonText, sectionContent, sectionDescription }: any) => {
  return (
              ...
              <Card className="bg-background">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">Simply speak to your assistant to check balances, make transfers, and more.</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-background">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">Talk naturally with your assistant as if you were speaking to a human banker.</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-background">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">Get personalized financial advice and insights from your AI assistant.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">Access your accounts, check balances, and manage your finances securely.</p>
              </div>
